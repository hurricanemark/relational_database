...
--
-- Name: elements alements_name_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT alements_name_key UNIQUE (name);


--
-- Name: elements alements_symbol_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT alements_symbol_key UNIQUE (symbol);
